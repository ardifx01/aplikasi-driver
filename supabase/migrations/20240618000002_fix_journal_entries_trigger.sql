-- Fix the dollar-quoted string syntax and handle missing booking_id column
...
-- Create function to handle booking and payment journal entries with proper dollar quoting
...
-- Create function to handle partial payment journal entries with proper dollar quoting
-- and safely check for booking_id column existence
